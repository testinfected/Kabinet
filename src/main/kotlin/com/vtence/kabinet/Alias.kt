...
class Alias<out T : Table>(val delegate: T, private val alias: String) : Table(delegate.tableName) {
    ...
    private fun <T : Any?> Column<T>.clone() = Column(this@Alias, name, type, autoGenerated, nullable)
